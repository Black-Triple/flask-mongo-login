...
def getValue():
    ...
    if (result.inserted_id):
        return render_template('success.html', f=fname, l=lname, g=lettergrade, yourid=value, id=result.inserted_id)
    else:
        return render_template('error.html', f=fname, l=lname, g=lettergrade,)
...
def returnwebsite():
    studentId=request.args.get('student_id')
    return render_template('deleted.html',arb=studentId)
